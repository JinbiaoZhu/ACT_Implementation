...
class Arguments:
    ...
    test_episode = 7  # 模型训练时放置于仿真环境测试的 episode 数
    ...
    batch_size = 50  # 因为图片很小, 所以 batch_size 可以调大一点
    num_step = 6000  # 每一个 step 表示一个 batch 做一次梯度下降
